        ...
        <section class="content-section">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6 mb-2 d-flex justify-content-end">
                    <a href="{{ url('/usuarios') }}" class="btn btn-outline-primary me-2">👥 Usuarios</a>
                    <a href="{{ url('/dashboard/configuracion') }}" class="btn btn-outline-secondary">⚙️ Configuración</a>
                </div>
            </div>
                ...
                <div class="col-md-4 d-flex">
                    <div class="card fade-in h-100 w-100">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <a href="{{ url('/proyectos/crear') }}" class="btn btn-success mt-auto">Crear</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex">
                ...
                <div class="col-md-6 mb-3 d-flex">
                    <div class="card h-100 w-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ url('/proyectos') }}" class="btn btn-outline-success mt-3">Ver todas las tareas</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-3 d-flex">
                    <div class="card h-100 w-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ url('/ayuda') }}" class="btn btn-outline-info">Guía rápida</a>
