        ...
        <section class="content-section text-center py-4">
            <div class="card fade-in shadow-sm mx-auto mb-4">
                <div class="card-body text-center py-4">
                    <img src="<?php echo e(asset('imagenes/logo.png')); ?>" alt="Nexus Compendium Logo" class="logo-image mb-2" style="width:300px;height:300px;">
            ...
            <div class="row justify-content-center g-4 mb-4">
                <div class="col-12 col-md-4 d-flex">
                    <div class="card fade-in h-100 w-100">
                        <div class="card-body text-center">
                            <img src="<?php echo e(asset('imagenes/proyecto.png')); ?>" alt="Proyectos" class="card-img-large mb-2">
                ...
                <div class="col-12 col-md-4 d-flex">
                    <div class="card fade-in h-100 w-100">
                        <div class="card-body text-center">
                            <img src="<?php echo e(asset('imagenes/usuarios.png')); ?>" alt="Usuarios" class="card-img-large mb-2">
                ...
                <div class="col-12 col-md-4 d-flex">
                    <div class="card fade-in h-100 w-100">
                        <div class="card-body text-center">
                            <img src="<?php echo e(asset('imagenes/alumnos.png')); ?>" alt="Alumnos" class="card-img-large mb-2">
            ...
            <div class="mb-5">
                <div class="card fade-in shadow-sm mx-auto w-100" style="max-width:100%;">
                    <div class="card-body py-4 text-center">
                        ...
                        <img src="<?php echo e(asset('imagenes/board_demo.png')); ?>" alt="Demo Board"
                ...
                <div class="col-12 col-md-4 mb-3 d-flex">
                    <div class="card fade-in h-100 w-100">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <a href="<?php echo e(url('/proyectos/crear')); ?>" class="btn btn-success mt-auto">Crear proyecto</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\NexusCompendium\resources\views/welcome.blade.php ENDPATH**/ ?>