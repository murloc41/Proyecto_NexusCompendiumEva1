                    ...
                    <div id="pendiente" class="kanban-list">
                        ...
                        <div class="kanban-card" data-id="3">
                            ...
                            <div class="kanban-actions">
                                <a href="<?php echo e(url('/proyectos/3')); ?>" class="btn btn-primary btn-sm">Ver</a>
                                <a href="<?php echo e(url('/proyectos/3/editar')); ?>" class="btn btn-success btn-sm">Actualizar</a>
                            </div>
                        </div>
                        <!-- ...más cards... -->
                    </div>
                ...
                <div class="kanban-column"  style="background-color: var(--verde-claro);">
                    ...
                    <div id="progreso" class="kanban-list">
                        ...
                        <div class="kanban-card" data-id="1"  style="background-color: var(--verde-claro);">
                            ...
                            <div class="kanban-actions">
                                <a href="<?php echo e(url('/proyectos/1')); ?>" class="btn btn-primary btn-sm">Ver</a>
                                <a href="<?php echo e(url('/proyectos/1/editar')); ?>" class="btn btn-success btn-sm">Actualizar</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="kanban-column"  style="background-color: var(--verde-claro);">
                    ...
                    <div id="finalizado" class="kanban-list">
                        ...
                        <div class="kanban-card" data-id="2"  style="background-color: var(--verde-claro);">
                            ...
                            <div class="kanban-actions">
                                <a href="<?php echo e(url('/proyectos/2')); ?>" class="btn btn-primary btn-sm">Ver</a>
                                <a href="<?php echo e(url('/proyectos/2/editar')); ?>" class="btn btn-success btn-sm">Actualizar</a>
                            </div>
                        </div>
                    </div>
                </div>
...
</html><?php /**PATH C:\laragon\www\NexusCompendium\resources\views/proyectos.blade.php ENDPATH**/ ?>